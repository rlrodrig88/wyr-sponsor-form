...
function sponsor_form() {
    ...
    <fieldset class="border">  
        <legend>Rack Information *</legend><span class="required">'. $rackErr . '</span>
        <div class="group">    
            <div class="row">
                <div class="rack-item">
        ...
        <div class="group">
            ...
            <div class="row">
                <div class="field full-width">
                    ...
                    <textarea rows="3" maxlength="400" id="location-area" name="area-description" class="entry" type="text">' . $_SESSION['post-data']['area-description'] . '</textarea>
                </div>    
            </div>
    ...
    <fieldset class="border">    
        <legend>Plaque Information</legend>
        <div class="group">
            <div class="row">
                <div class="field full-width">
                    <div class="field-label">Description</div>
                    <textarea rows="3" maxlength="400" id="plaque-description" name="plaque-description" class="entry" type="text">' . $_SESSION['post-data']['plaque-description'] . '</textarea>
                </div>
            </div>
            <div class="row">
                <div class="field">
...
function sponsor_form_review() {
	$output = 
	'<h2>Please review and confirm your sponsorship information:</h2>
	<fieldset class="border">
	    <legend>Sponsor Information</legend>
	    <div class="group">'
    ...
    <fieldset class="border">
        ...
        <div class="group">
        	Hitch Post Racks: ' . $_SESSION['post-data']['hitch-post-quantity'] . '</br>
        	Corrals: ' . $_SESSION['post-data']['corral-quantity'] . '	
        </div>
    </fieldset>
    <fieldset class="border">
        <legend>Rack Location</legend>
    ...
    <fieldset class="border">
        ...
        <div class="group">'
    	    ...
    	    <p>Uploaded Files:  ' . ((!null == $_FILES["fileToUpload"]["name"]) ?  $_FILES["fileToUpload"]["name"] : "None") . '</p>
        </div>
    </fieldset>
    <fieldset class="border">
        <legend>Payment Information</legend>
        <div class="group">'
            . (($_SESSION['post-data']['payment-type'] = 'credit') ? "Credit Card" : "Check") . '</br></br>	
        </div>
    </fieldset>
